		  	...
		  	<div class="col-md-12">
		  		<div class="col-md-6">
			  		<div class="form-group">
						<label for="fname" class="col-sm-4 control-label">Nama Depan : </label>
					   	<div class="col-sm-8">
					      <input type="text" class="form-control" id="fname" name="fname" placeholder="Nama Depan" />
					    </div>
					</div>
					<div class="form-group">
					    <label for="lname" class="col-sm-4 control-label">Nama Belakang : </label>
					    <div class="col-sm-8">
					...
					<div class="form-group">
				  	...
				  	<div class="form-group">
				    	<label for="age" class="col-sm-4 control-label">Umur: </label>
				    	<div class="col-sm-8">
				      		<input type="text" class="form-control" id="age" name="age" placeholder="Umur" />
				    	</div>
				  	</div>
				  	<div class="form-group">
				    	<label for="contact" class="col-sm-4 control-label">Kontak: </label>
				    	<div class="col-sm-8">
				      		<input type="text" class="form-control" id="contact" name="contact" placeholder="Kontak" />
				    	</div>
				  	</div>	
				  	<div class="form-group">
				  	...
				  	<div class="form-group">
				    	<label for="country" class="col-sm-4 control-label">Negara: </label>
				    	<div class="col-sm-8">
		  		...
		  		<div class="col-md-6">
		  			<div class="form-group">
						<label for="registerDate" class="col-sm-4 control-label">Tanggal Input : </label>
					   	<div class="col-sm-8">
					      <input type="text" class="form-control" id="registerDate" name="registerDate" placeholder="Tanggal Input" />
					    </div>
					</div>
					<div class="form-group">
				    	<label for="jobType" class="col-sm-4 control-label">Tipe Pekerjaan: </label>
				    	<div class="col-sm-8">
    		...
    		<form class="form-horizontal" method="post" action="teacher/updateInfo" id="updateTeacherInfoForm">
			  	<div class="row">
				  	...
				  	<div class="col-md-12">
				  		...
				  		<div class="col-md-6">
				  			<div class="form-group">
								<label for="editRegisterDate" class="col-sm-4 control-label">Tanggal Input : </label>
							   	<div class="col-sm-8">
							      <input type="text" class="form-control" id="editRegisterDate" name="editRegisterDate" placeholder="Tanggal Input" />
							    </div>
							</div>
							<div class="form-group">
						    	<label for="editJobType" class="col-sm-4 control-label">Tipe Pekerjaan: </label>
						    	<div class="col-sm-8">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeTeacherModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-primary" id="removeTeacherBtn">Yakin</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
