...
<ol class="breadcrumb">
  ...
  if($this->input->get('opt') == 'addst') {
    echo '<li class="active">Tambah Murid</li>';
  } 
  else if ($this->input->get('opt') == 'mgst') {
    echo '<li class="active">Kelola Murid</li>';
  }
  ?>  
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-primary" id="removeStudentBtn">Simpan</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
