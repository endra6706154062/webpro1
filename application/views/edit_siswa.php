		...
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					...
					<a class="brand" href="index.html"> INTERPID </a>
								...
								<div class="module-body">
									<div class="stream-composer media">
										<div class="media-body">
											<?php echo form_open("siswa/action_edit_mhs/".$nisn); ?> 
												<h5>NISN :</h5>
												<div class="row-fluid">
													<input type="text" name="nisn" value="<?php echo $nisn; ?>" class="span12" style="height: 30px; resize: none;" disabled></input>
												</div>
												<h5>Nama Lenkap :</h5>
												<div class="row-fluid">
												...
												<h5>Tanggal Lahir :</h5>
												<div class="row-fluid">
													<input type="date" name="tgl" class="span12" style="height: 30px;"></input>
												</div>
												<h5>Agama :</h5>
												<div class="row-fluid">
