<ol class="breadcrumb">
  ...
  <li class="active">Kelola Subjek</li>
</ol>
...
<div class="row">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">Kelola Subjek</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <label for="sectionName">Subjek</label>
		    <input type="text" class="form-control" id="subjectName" name="subjectName" placeholder="Subjek">
		  </div>
		  <div class="form-group">
		    <label for="totalMark">Total Jam Pelajaran</label>
		    <input type="text" class="form-control" id="totalMark" name="totalMark" placeholder="Total Jam Pelajaran">
		  </div>
		  <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <label for="editSubjectName">Subjek</label>
		    <input type="text" class="form-control" id="editSubjectName" name="editSubjectName" placeholder="Subjek">
		  </div>
		  <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeSubjectModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Hapus Subjek</h4>
      </div>
      <div class="modal-body">
        <div id="remove-messages"></div>

        <p>Anda yakin ingin hapus subjek ini?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-primary" id="removeSubjectBtn">Simpan</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
